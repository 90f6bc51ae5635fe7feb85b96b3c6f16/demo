...
--
-- Host: localhost
-- Generation Time: Sep 22, 2019 at 08:11 AM
...
CREATE TABLE `tb_customer` (
  ...
  `customer_size_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL COMMENT 'รหัสอ้างอิงกลุ่มลูกค้า',
  `customer_approve` varchar(50) NOT NULL COMMENT 'การอนุมัติ [New,Request,Approved]',
  `customer_end_user_type` int(11) NOT NULL COMMENT 'ประเภท End user ',
  `customer_register_date` varchar(50) NOT NULL,
  `customer_register_relimit` int(11) NOT NULL,
  `customer_register_status` varchar(50) NOT NULL,
...
--
-- Table structure for table `tb_customer_size`
--

CREATE TABLE `tb_customer_size` (
  `customer_size_id` int(11) NOT NULL,
  `customer_size_name` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `tb_customer_size`
--

INSERT INTO `tb_customer_size` (`customer_size_id`, `customer_size_name`) VALUES
(1, 'Big'),
(2, 'Agent/Trade'),
(3, 'Dealer'),
(4, 'Premium');
...
(4, 'สิทธิ์การใช้งาน Sales & Application Manager', 'High', 'High', 'High', 'High', 'High', 'High', 'Medium', 'High', 'No', 'Medium', 'High'),
(5, 'สิทธิ์การใช้งาน Sales Coordinator', 'High', 'Medium', 'Medium', 'Medium', 'Medium', 'High', 'High', 'High', 'No', 'Medium', 'No'),
...
(10, 'ผู้ดูแลระบบ ขึ้นต่ำ', 'High', 'High', 'High', 'High', 'High', 'High', 'High', 'High', 'No', 'Medium', 'No');
...
(16, 9, 'SI|year:2|month:2|-|number:3|', 'ใบกำกับภาษี', 'Customer invoice', 3, 'ขายเชื่อให้ |customer_name|', 0),
(17, 9, 'CN|year:2|-|number:3|', 'ใบลดหนี้', 'Credit note', 4, 'ลดหนี้ขายเชื่อให้ {customer_name}', 0),
(18, 9, 'DN|year:2|-|number:3|', 'ใบเพิ่มหนี้', 'Debit note', 4, 'เพิ่มหนี้ขายเชื่อให้ {customer_name}', 0),
...
(33, 5, 'OC|year:2|month:2|number:3|', 'ใบสั่งซื้อแบบออนไลน์', '	\r\nPurchase Order', 0, '', 0),
(34, 16, 'RL|year:2|month:2|-|number:3|', 'ใบโอนย้ายคลังสินค้า', 'Stock Move', 0, '', 0),
(35, 2, 'SSDN|year:2|month:2|number:3|', 'ออกใบยืมให้ซัพพลายเออร์', 'supplier send delivery note', 0, '', 0),
(36, 7, '|supplier_code:6|-|employee_name:2|-|year:2|month:2|number:3|', 'ใบเสนอราคาซัพพลายเออร์', 'Quotation Supplier', 0, '', 0),
(37, 17, 'SPS|year:2|month:2|-|number:3|', 'ใบรวมสินค้าแบบชุด', 'Product Set', 0, '', 0),
(38, 6, 'RRTMP|year:2|month:2|-|number:3|', 'ใบรับสินค้าภายในประเทศชั่วคราว', 'Supplier Invoice Tmp', 0, 'ซื้อเชื่อภายในประเทศจาก {supplier_name} ชั่วคราว ', 0),
(39, 6, 'RFTMP|year:2|month:2|-|number:3|', 'ใบรับสินค้าภายในประเทศชั่วคราว', 'Supplier Invoice Tmp', 0, 'ซื้อเชื่อภายนอกประเทศจาก {supplier_name} ชั่วคราว ', 0),
(40, 2, 'DNCR|year:2|month:2|number:3|', 'รับใบยืมลูกค้า', 'delivery note customer receive', 0, '', 0),
(42, 18, 'CNS|year:2|-|number:3|', 'ใบลดหนี้ซัพพลายเออร์', 'Credit note supplier', 0, '', 0),
(41, 8, 'customer_name:1|number:3|', 'รหัสลูกค้า', 'Customer code', 0, '', 0),
(43, 9, 'JU|year:2|month:2|-|number:3|', 'ใบตัดต้นทุนสินค้า', 'Stock issue', 0, '', 0),
(44, 19, 'CSR|year:2|month:2|number:3|', 'ใบรายงานการบริการ', 'Customer Service Report', 0, '', 0),
(45, 8, '[E]-|customer_name:1|number:3|', 'รหัสลูกค้าปลายทาง', 'Customer End user', 0, '', 0);
...
(14, 'เอกสารเช็ค'),
(15, 'เอกสารสมุดรายวัน'),
(16, 'เอกสารโอนย้ายคลังสินค้า'),
(17, 'เอกสารรวมสินค้าแบบชุด'),
(18, 'เอกสารผู้ขาย'),
(19, 'เอกสารรายงานการบริการ');
...
CREATE TABLE `tb_player` (
  ...
  `player_type` int(11) NOT NULL COMMENT '0=WEB, 1=APP'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tb_player` (`player_id_id`, `player_id`, `user_id`, `player_type`) VALUES
(10, '7ea69e73-8006-4ccf-b2aa-725cdf8e73b3', 5, 1),
(11, '566046d8-529c-4db7-bc69-d31a624795b3', 25, 1),
(12, 'f684f69c-9c83-434b-b48f-4c0bdc1b410b', 12, 1),
(13, '', 25, 1),
(14, '1228559c-2e72-49b1-9e12-3a5a72e4670e', 12, 1),
(15, '80f19be2-bb3a-45e3-9596-dd0c0ead9b54', 25, 1),
(16, '97fc19d4-61ce-4bb5-8f63-18ec4675dbc7', 25, 1),
(17, 'cb35d098-c632-4986-95ab-7356433570c2', 11, 1),
(18, '499e616a-ac4c-480d-b26c-ce52689c4e98', 12, 1),
(19, '6f6e1315-1152-4a48-b58f-053b5801a84d', 25, 1),
(20, 'ecbbfa6e-b83d-4e8d-96a0-2a957aad190f', 12, 1),
(21, 'dc085e76-db27-428e-be7c-711392c8015e', 25, 1),
(22, 'b3b16a22-fae4-4b5c-b31d-416325b4f636', 25, 1),
(23, 'b125b927-ab17-4b8b-ab3f-762004705409', 22, 1),
(24, '2dafc6ed-c71f-4add-ab2d-cb0c92cc049c', 21, 1),
(25, '746a70a8-633c-4245-b8e4-0482f47a06ed', 25, 1),
(26, '7f08fb61-c0db-4880-80c6-a3f7b9677881', 25, 1),
(27, '286ffe8f-a053-4168-ba5c-8c916d009f0b', 25, 1),
(28, '0664e7a2-68f6-4821-8119-c9ff293d5812', 25, 1),
(29, '83f7ca2a-1bd2-45e2-ac9b-9cacaeb41bb7', 20, 1),
(30, '9e170b9e-f0bb-4ccf-a78f-5c67da67315f', 25, 1);
...
--
-- Indexes for table `tb_customer_size`
--
ALTER TABLE `tb_customer_size`
  ADD PRIMARY KEY (`customer_size_id`);
...
--
ALTER TABLE `tb_customer`
  MODIFY `customer_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสผู้ขาย', AUTO_INCREMENT=137;
--
-- AUTO_INCREMENT for table `tb_customer_size`
--
ALTER TABLE `tb_customer_size`
  MODIFY `customer_size_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `tb_paper_type`
  MODIFY `paper_type_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสอ้างอิงประเภทเอกสาร', AUTO_INCREMENT=20;
--
-- AUTO_INCREMENT for table `tb_player`
--
ALTER TABLE `tb_player`
  MODIFY `player_id_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
--
