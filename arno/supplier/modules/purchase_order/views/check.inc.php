    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form role="form" method="post" onsubmit="return check();" action="index.php?app=purchase_order&action=update_checking&id=<?php echo $purchase_order_id;?>" >
                    ...
                    <div class="row">
                        <div class="col-lg-offset-9 col-lg-3" align="right">
                            ...
                            <?php 
                            if( $purchase_order['purchase_order_status'] == 'Checking'){
                            ?>
