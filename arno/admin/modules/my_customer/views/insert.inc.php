    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form role="form" id="form_target" method="post" onsubmit="return check();" action="index.php?app=my_customer&action=add" enctype="multipart/form-data">  
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input id="customer_end_user_type" name="customer_end_user_type" type="hidden" value="0" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select id="customer_end_user" name="customer_end_user" class="form-control select" data-live-search="true" <?PHP if($customer['customer_end_user_type'] == '0'){?> Disabled <?PHP }?> >
...
<!--                                           
                    ...
                    <div class="row" >
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label>กลุ่มราคาลูกค้า / Customer Price List</label>
                    ...
                    <div class="row">
                        <div class="col-lg-offset-9 col-lg-3" align="right"> 
                            ...
                            <button type="button" id="save" onclick="set_customer_approve('New');check_login('form_target');" class="btn btn-success">Save</button>
                            <button type="button" id="save_request" onclick="set_customer_approve('<?php echo $customer_approve; ?>');check_login('form_target');" class="btn btn-success">Save & Request</button>
                        </div>
                    </div>
                </form>
            </div>
